...
def database_connection(id_num,destination):
    ...
    try:
        with connection.cursor() as cursor:
            ...
            # sql1= "SELECT id,source,destination,start_at,end_at from tracked where id =%s"
            # cursor.execute(sql,prisoner_id)
...
#     logs = {
#         id:
#             {'source':source, 'destination':destination,'starttime':starttime,'endtime':endtime},
#         }
